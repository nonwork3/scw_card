...
function generateSignature(v) {
  ...
  const phoneRow     = v.phone ? `
      <table cellpadding="0" cellspacing="0" border="0">
        <tr><td style="padding-bottom:5px;mso-line-height-rule:exactly;line-height:1.2;">
...
<table id="sig" cellpadding="0" cellspacing="0" border="0"
  style="font-family:Arial,Helvetica,sans-serif;font-size:13px;color:#333333;background:#ffffff;padding:16px 20px;width:420px;max-width:420px;border-collapse:collapse;border-spacing:0;">
  <tr>
    <td colspan="2" style="padding-bottom:8px;line-height:1;mso-line-height-rule:exactly;">
  ...
  <tr>
    <td colspan="2" style="padding-bottom:1px;line-height:1.3;mso-line-height-rule:exactly;">
      <span style="font-size:15px;font-weight:bold;color:#111111;">${v.nameTH}</span>
    </td>
  </tr>
  <tr>
    <td colspan="2" style="padding-bottom:12px;line-height:1.4;white-space:nowrap;mso-line-height-rule:exactly;">
  ...
  <tr>
    <td colspan="2"
      style="padding:6px 0;font-size:0;line-height:0;border-bottom:1.5px solid #1D9E75;mso-line-height-rule:exactly;">
    </td>
  </tr>
  <tr>
    <td style="vertical-align:top;padding-right:16px;mso-line-height-rule:exactly;line-height:1.2;">
      <table cellpadding="0" cellspacing="0" border="0">
        <tr><td style="padding-bottom:5px;mso-line-height-rule:exactly;line-height:1.2;">
          <span style="font-size:12px;color:#888888;">&#9993;&nbsp;</span>
    ...
    <td style="vertical-align:middle;text-align:center;width:90px;mso-line-height-rule:exactly;line-height:1;">
