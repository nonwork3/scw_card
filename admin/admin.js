...
<table id="sig" cellpadding="0" cellspacing="0" border="0"
  style="font-family:Arial,Helvetica,sans-serif;font-size:13px;color:#333333;background:#ffffff;padding:12px 12px;width:400px;max-width:400px;border-collapse:collapse;border-spacing:0;">
  <tr>
  ...
  <tr>
    <td colspan="2" style="vertical-align:top;mso-line-height-rule:exactly;line-height:1.2;">
      <table cellpadding="0" cellspacing="0" border="0">
        <tr><td style="padding-bottom:3px;mso-line-height-rule:exactly;line-height:1.2;">
          <span style="font-size:12px;color:#888888;">&#9993;&nbsp;</span>
        ...
        <tr>
          ...
          <td style="vertical-align:middle;padding-right:10px;">
            <a href="${cardURL}" style="display:block;text-decoration:none;">
              <img src="https://api.qrserver.com/v1/create-qr-code/?size=60x60&color=0F6E56&data=${qrData}"
                alt="QR Code" width="60" height="60" style="display:block;border:0;border-radius:4px;">
            </a>
          </td>
          <td style="vertical-align:middle;">
            <span style="font-size:10px;color:#aaaaaa;white-space:nowrap;mso-line-height-rule:exactly;line-height:1.2;">สแกนบันทึก contact</span>
          </td>
        </tr>
      </table>
    </td>
